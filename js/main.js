...
document.getElementById('appointment-form').addEventListener('submit', function(s){
    ...
    let appointment = {
        ...
        email: document.getElementById('appointent-email').value,
    ...
    if(allFields) {
        createAppointment('wysłanie foma');
    } else {
